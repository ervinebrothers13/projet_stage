<?php
/**
 * Template Name: offre stage pfmp
 * Description: Pages offre stage pfmp
 */
...
if(!isset($_SESSION['filterpfmp']))$_SESSION['filterpfmp']='-1';

$tabfilte=explode(",",$_SESSION['filterpfmp']);
...
<section id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	...
	$lstoffrepfmpsize=recData("lstoffrepfmpsize",$_SESSION['filterpfmp']);
	
	$alllststagepfmp=lstData("alllststagepfmp",array($_SESSION['filterpfmp'],$offset,$limit));
	
	$nbpage=floor($lstoffrepfmpsize["NB"]/$limit);
	...
	<div id="offrecontent" class="offrecontentclass">
		<div class="topcontent">
					...
					<div class="title"><?php echo $lstoffrepfmpsize["NB"]; ?> offres de stage</div>
		...
		<?php 
			...
			foreach($alllststagepfmp as $offre){
				...
				<article>
					<div class="article_body">
							...
							<div class="article_body_content">
								<h4 class="body_title">
									<a href="<?php echo get_site_url(); ?>/offre-stage/?pfmp=<?php echo $stageid; ?>" ><?php echo $offre["metier"]; ?></a>
								</h4>
					...
					<div  class="article_header">
						<div>
							...
							?>
							<a href="<?php echo get_site_url(); ?>/offre-stage/?pfmp=<?php echo $stageid; ?>" ><img class="fr-responsive-img" src="<?php echo $image; ?>" alt="secteur" data-fr-js-ratio="true"></a>
						</div>
						<ul class="categorielist">
							<li class="cateitemli">
								<a href="<?php echo get_site_url(); ?>/offre-stage/?pfmp=<?php echo $stageid; ?>" ><div class="cateitem"><?php echo ($offre["sect_lib"]); ?></div></a>
							</li>
						</ul>
					</div>
			...
			<div class="col-sm-12" >
				...
				<div id="pagination">
				 ...
				 <?php
						...
						if($page<$lstoffrepfmpsize["NB"] and $lstoffrepfmpsize["NB"]>$limit){
	...
	<div id="filterdiv">
		...
		<div class="middle_filter">
			...
			<div id="listfilter" class="row">
				...
				$lstsecteur=lstData("lstsecteur2");
