<?php
/**
 * Template Name: réinit password entrprise
 * Description: réinit password entrprise
 */
...
<section id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
    ...
    <div id="forgetpassworddiv" class="formconnect" >
        <form id="forgetpassword-form" method="POST"
              action="<?php echo get_template_directory_uri(); ?>/actiondev2.php?act=reinitpasswordent">
