    ...
    <form method="GET" id="form">
		...
		<div class="row">
		   ...
		   <div class="col-6 row paddingright40">
			...
			<?php if(isset($_GET["niveau"]) or isset($_GET["ressources-enseignants"])){ ?>
			<div class="col-6 row">
				<a id="filtrerbutcancel" href="<?php echo get_site_url(); ?>/enseignants/ressources-interdisciplinaires/" class="btn btn-secondary" ><i class="fa fa-window-close-o" aria-hidden="true"></i>Annuler</a>
			</div>
    ...
    <div id="contentarticle">
		...
		$cpt=0;
			foreach($posts as $post){
				...
				if(in_array($parentarray[2],$lstcategories))$good2=1;
