<?php
/**
 * Template Name: offre stage 3eme
 * Description: Pages offre stage 3eme
 */
...
if(!isset($_SESSION['filter3eme']))$_SESSION['filter3eme']='-1';

$tabfilte=explode(",",$_SESSION['filter3eme']);
...
<section id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	...
	$lstoffre3emesize=recData("lstoffre3emesize",$_SESSION['filter3eme']);
	
	$lstoffre3eme=lstData("alllststage3eme",array($_SESSION['filter3eme'],$offset,$limit));
	
	$nbpage=floor($lstoffre3emesize["NB"]/$limit);
	...
	<div id="offrecontent" class="offrecontentclass">
		<div class="topcontent">
					...
					<div class="title"><?php echo $lstoffre3emesize["NB"]; ?> offres de stage</div>
		...
		?>
				...
				<article>
					<div class="article_body">
							...
							<div class="article_body_content">
								<h4 class="body_title">
									<a href="<?php echo get_site_url(); ?>/offre-stage/?offre3eme=<?php echo $stageid; ?>" ><?php echo $offre["metier"]; ?></a>
								</h4>
					...
					<div  class="article_header">
						<div>
							<?php
								...
								if(!file_exists($_SERVER['DOCUMENT_ROOT'].'/monstage/wp-content/themes/Avada/images/categorie/'.$offre["dom_id"].'.png'))$image=get_template_directory_uri()."/images/categorie/default_sector.svg";
								
								
							?>
							<a href="<?php echo get_site_url(); ?>/offre-stage/?offre3eme=<?php echo $stageid; ?>" ><img class="fr-responsive-img" src="<?php echo $image; ?>" alt="secteur" data-fr-js-ratio="true"></a>
						</div>
						<ul class="categorielist">
							<li class="cateitemli">
								<a href="<?php echo get_site_url(); ?>/offre-stage/?offre3eme=<?php echo $stageid; ?>" ><div class="cateitem"><?php echo ($offre["sect_lib"]); ?></div></a>
							</li>
						</ul>
					</div>
			...
			<div class="col-sm-12" >
				...
				<div id="pagination">
					...
					?>
				  <a class="page prev" href="<?php echo get_site_url(); ?>/liste-des-stages-3eme/?pg=<?php echo ($page-1); ?>">Previous</a>
					<?php
					...
					for($i=1;$i<=$nbpage;$i++){
						...
						<a class="page <?php echo $active; ?>" href="<?php echo get_site_url(); ?>/liste-des-stages-3eme/?pg=<?php echo $i; ?>"><?php echo $i; ?></a>
				 ...
				 <?php
						...
						if($page<$lstoffre3emesize["NB"] and $lstoffre3emesize["NB"]>$limit){
					
					?>
				  <a class="page next" href="<?php echo get_site_url(); ?>/liste-des-stages-3eme/?pg=<?php echo ($page+1); ?>">Next</a>
				  <?php
	...
	<div id="filterdiv">
		...
		<div class="middle_filter">
			...
			<div id="listfilter" class="row">
				...
				$lstsecteur=lstData("lstsecteur1");
		...
		<div class="bottom_filter">
			<span class="removefilter" onclick="removefilter3eme()">Tout effacer</span>
			<button class="bouttonconnex3" id="applyfilter3eme"onclick="applyfilter3eme()">Appliquer ces filtres</button>
		</div>
